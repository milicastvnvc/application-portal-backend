...
class ApplicationService implements IApplicationService
{
    ...
    public function getAllApplications($page = 1, $search_key = '', $mobility_id = null, $home_institution_id = null, $per_page = 10, $status = null, $call_id = null): ActionResultResponse
    {
        $response = new ActionResultResponse();

        $pagination = $this->applicationRepository->getAllApplications($page, $search_key, $mobility_id, $home_institution_id, $per_page, $status, $call_id);
